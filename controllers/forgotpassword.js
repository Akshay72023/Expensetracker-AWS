    ...
    try {
      ...
      if (user.email) {
        ...
        const mailOptions = {
          ...
          html: `<p>Click the link below to reset your password:</p><a href="http://51.20.122.16:3000/password/resetpassword/${id}">Reset password</a>`
        };
        ...
        if(forgotpasswordrequest){
            ...
            res.status(200).send(`<html>
                        <body>
                            ...
                            <form action="http://51.20.122.16:3000/password/updatepassword/${id}" id="form" method="get">
